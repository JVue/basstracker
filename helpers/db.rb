...
class DB
  ...
  def add_entry(date, time, angler, event, weight, weight_decimal, weight_oz, bass_type, state, lake = nil)
  ...
  def get_entry(time, date, angler, event, weight, bass_type, state, lake)
